    ...
    <section className="py-20 px-6 bg-muted/30">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg text-muted-foreground mb-12">
          ...
          how my experience can contribute to your team's success.
        </p>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4 p-4 bg-card rounded-lg border">
              ...
              <div className="text-left">
                ...
                <div className="text-sm text-muted-foreground">jmaroon@mail.wlu.edu</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 p-4 bg-card rounded-lg border">
              ...
              <div className="text-left">
                ...
                <div className="text-sm text-muted-foreground">(612) 512-6977</div>
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="p-6 bg-card rounded-lg border text-left">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Available for full-time product management roles starting May 2026. 
                Open to internships and part-time opportunities before graduation.
              </p>
